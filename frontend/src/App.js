...
// import WoundCare from './components/servicePages/WoundCare';
  ...
  return (
    ...
    <nav id="regularMenu" role="navigation">
      ...
      <Switch>
        ...
        {/* <Route exact path='/our-services/wound-care' render={() => <WoundCare/>} /> */}
...
{/* routes to individual blogs */}
      ...
      <footer>
        ...
        <p>© 2020 Encompass HealthCare & Wound Medicine | Site Developed by Jada Woody</p>
